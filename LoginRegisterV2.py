...
class User:
    def __init__(self, main_window, user_id):
        ...
        self.activity_frame = tk.Frame(self.window, width=1050, height=600, bg='white')
        self.activity_frame.pack()

        a = tk.Label(self.activity_frame, text='user')
        a.place(x=100, y=100)
        b = tk.Button(self.activity_frame, text='logout', command=lambda: self.logout())
        b.place(x=200, y=200)
...
class Clinic:
    def __init__(self, main_window, user_id):
        ...
        a = tk.Label(self.activity_frame, text='clinic')
        a.place(x=100, y=100)
        b = tk.Button(self.activity_frame, text='logout', command=lambda: self.logout())
        b.place(x=200, y=200)
...
class Doctor:
    def __init__(self, main_window, user_id):
        ...
        a = tk.Label(self.activity_frame, text='doctor')
        a.place(x=100, y=100)
        b = tk.Button(self.activity_frame, text='logout', command=lambda: self.logout())
        b.place(x=200, y=200)
...
class Admin:
    def __init__(self, main_window, user_id):
        ...
        a = tk.Label(self.activity_frame, text='admin')
        a.place(x=100, y=100)
        b = tk.Button(self.activity_frame, text='logout', command=lambda: self.logout())
        b.place(x=200, y=200)
